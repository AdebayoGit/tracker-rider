...
class AppTheme {
  ...
  static const Color secondaryColor = Color(0xFF5C67B5);
  static const Color secondaryLightColor = Color(0xFF5CA2B5);
  static const Color secondaryDarkColor = Color(0xFF323C6D);
  static const Color primaryColor = Color(0xFF343434);
  static const Color primaryLightColor = Color(0xFF5E5E5E);
